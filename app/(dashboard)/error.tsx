...
export default function DashboardError({
    ...
    return (
        <div className="flex h-full min-h-[60vh] w-full flex-col items-center justify-center px-6 py-24 text-center">
            <div className="w-10 h-10 border border-black bg-white flex items-center justify-center mb-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link
                    href="/"
                    className="bg-white text-black px-5 py-2.5 font-mono text-xs uppercase tracking-wide hover:bg-neutral-100 transition-colors border border-black"
                >
                    Dashboard Home
                </Link>
            </div>
