    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
            ...
            <div className="space-y-2">
                <h2 className="font-serif text-2xl font-normal">Failed to load billing</h2>
                <p className="font-mono text-sm text-neutral-500 max-w-sm">
                    {error.digest ? `Ref: ${error.digest}` : "Could not load your billing information. Please try again."}
                </p>
            </div>
