    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
            ...
            <div className="space-y-2">
                <h2 className="font-serif text-2xl font-normal">Failed to load submit form</h2>
                <p className="font-mono text-sm text-neutral-500 max-w-sm">
                    {error.digest ? `Ref: ${error.digest}` : "Could not load the tool submission form. Please try again."}
                </p>
            </div>
            <div className="flex gap-3">
                ...
                <Link href="/tools" className="border border-black px-4 py-2 font-mono text-sm hover:bg-neutral-100 transition-colors">
                    View Tools
                </Link>
            </div>
        </div>
