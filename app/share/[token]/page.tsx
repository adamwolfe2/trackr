            ...
            <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
                ...
                <div className="border border-black p-5 text-center">
                    ...
                    <a
                        ...
                        className="inline-block bg-black text-white px-6 py-2.5 font-mono text-xs uppercase tracking-wide border border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all"
                    >
                        Try Trackr Free
                    </a>
                </div>
