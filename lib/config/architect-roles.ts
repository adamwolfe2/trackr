export const ARCHITECT_ROLES = [
  ...
  { slug: "fractional-caio", title: "Fractional CAIO", description: "Embed as Chief AI Officer for companies navigating AI infrastructure, vendor selection, and deployment" },
