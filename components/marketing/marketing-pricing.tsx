...
const plans: PlanCard[] = [
    {
        ...
        credits: "5 research credits/month",
        extraCredits: "Buy credit packs anytime",
        features: [
            { text: "15 tools in database", included: true },
            { text: "1 workspace member", included: true },
            { text: "Basic research reports", included: true },
            { text: "Compare tools (2 max)", included: true },
            { text: "Limited tool comparison", included: true },
    ...
    },
    {
        ...
        extraCredits: "Credit packs from $10",
        badge: "Most Popular",
        featured: true,
        features: [
            ...
            { text: "Spend tracking + procurement", included: true },
            { text: "Renewal calendar", included: true },
            { text: "Decision log", included: true },
            { text: "Public stack profile", included: true },
    ...
    },
    {
        ...
        extraCredits: "Credit packs from $8 (20% off)",
        features: [
            { text: "Everything in Team", included: true },
            { text: "15 workspace members", included: true },
            { text: "Ask Trackr AI (unlimited)", included: true },
            { text: "Analytics + scorecard recipe", included: true },
            { text: "Stack Health (full)", included: true },
            { text: "Board reports", included: true },
            { text: "Competitor intel", included: true },
            { text: "Risk monitor", included: true },
            { text: "Contract vault", included: true },
            { text: "Team literacy", included: true },
    ...
    },
    {
        ...
        extraCredits: "Credit packs from $6 (40% off)",
        features: [
